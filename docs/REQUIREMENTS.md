...
- **R-AUTH-2** PWA wykrywa brak autoryzacji (odpowiedź 401/403 od nginx albo przekierowanie na stronę logowania zamiast JSON) i pokazuje ekran „Połącz z Cezarem”.
