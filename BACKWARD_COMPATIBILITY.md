...
- **Required path:** update `README.md` deploy notes in the same PR, keep `deploy/nginx/rehearse.sh` and `deploy/push/rehearse.sh` green, label `risk-high`, spell out any manual step on the host.
